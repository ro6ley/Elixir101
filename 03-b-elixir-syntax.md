...
To compile our simple Math module save it as `math.ex` and use `elixirc`, in your terminal: 
```
$ elixirc math.ex
```
...
Elixir modules support attributes, there are built-in attributes and you may also add custom ones:
```
defmodule MyMod do
  @moduledoc """
